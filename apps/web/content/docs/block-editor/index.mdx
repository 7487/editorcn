...
<CodeBlockCommand
  __npm__={"npx shadcn@latest add @editorcn/block-editor"}
  __yarn__={"yarn dlx shadcn@latest add @editorcn/block-editor"}
  __pnpm__={"pnpm dlx shadcn@latest add @editorcn/block-editor"}
  __bun__={"bunx shadcn@latest add @editorcn/block-editor"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @editorcn/block-editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/suggestion @tiptap/extension-drag-handle-react"}
  __yarn__={"yarn add @editorcn/block-editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/suggestion @tiptap/extension-drag-handle-react"}
  __pnpm__={"pnpm add @editorcn/block-editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/suggestion @tiptap/extension-drag-handle-react"}
  __bun__={"bun add @editorcn/block-editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/suggestion @tiptap/extension-drag-handle-react"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-placeholder @tiptap/extension-underline @tiptap/extension-task-item @tiptap/extension-task-list @tiptap/extension-image @tiptap/extension-table @tiptap/extension-table-row @tiptap/extension-table-cell @tiptap/extension-table-header"}
  __yarn__={"yarn add @tiptap/extension-placeholder @tiptap/extension-underline @tiptap/extension-task-item @tiptap/extension-task-list @tiptap/extension-image @tiptap/extension-table @tiptap/extension-table-row @tiptap/extension-table-cell @tiptap/extension-table-header"}
  __pnpm__={"pnpm add @tiptap/extension-placeholder @tiptap/extension-underline @tiptap/extension-task-item @tiptap/extension-task-list @tiptap/extension-image @tiptap/extension-table @tiptap/extension-table-row @tiptap/extension-table-cell @tiptap/extension-table-header"}
  __bun__={"bun add @tiptap/extension-placeholder @tiptap/extension-underline @tiptap/extension-task-item @tiptap/extension-task-list @tiptap/extension-image @tiptap/extension-table @tiptap/extension-table-row @tiptap/extension-table-cell @tiptap/extension-table-header"}
/>
...
Override any built-in icon via the `icons` prop. All icons accept a `ReactNode`, so you can use inline SVGs, emoji, or any icon library.
...
The code block language selector shows per-language icons (e.g. a JavaScript icon for JS, a Python icon for Python). Override them via the `languageIcons` key:
