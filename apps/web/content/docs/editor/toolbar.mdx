...
description: All available toolbar controls for @editorcn/editor.
...
> These controls are for the **toolbar-style** editor (`@editorcn/editor`). For the block-style editor, see [`@editorcn/block-editor`](../block-editor).
