...
<CodeBlockCommand
  __npm__={"npx shadcn@latest add @rtecn/editor"}
  __yarn__={"yarn dlx shadcn@latest add @rtecn/editor"}
  __pnpm__={"pnpm dlx shadcn@latest add @rtecn/editor"}
  __bun__={"bunx shadcn@latest add @rtecn/editor"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @rtecn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
  __yarn__={"yarn add @rtecn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
  __pnpm__={"pnpm add @rtecn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
  __bun__={"bun add @rtecn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
/>
...
`@rtecn/editor` ships with two embed extensions for embedding YouTube videos and tweets. They are self-contained (no extra Tiptap packages needed) and include resizable node views with drag handles.
...
```tsx
import { YouTubeEmbed, RichTextEditor } from "@rtecn/editor";
...
```tsx
import { TwitterEmbed, RichTextEditor } from "@rtecn/editor";
...
```tsx
import { YouTubeEmbed, TwitterEmbed, RichTextEditor } from "@rtecn/editor";
