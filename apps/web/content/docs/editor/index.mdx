...
<CodeBlockCommand
  __npm__={"npm install @editorcn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
  __yarn__={"yarn add @editorcn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
  __pnpm__={"pnpm add @editorcn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
  __bun__={"bun add @editorcn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder"}
/>
...
```
  ...
  If you installed via the shadcn registry, the package is copied into your project, so import from your local components path instead of `@editorcn/editor` throughout this page:
  ```tsx
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-underline"}
  __yarn__={"yarn add @tiptap/extension-underline"}
  __pnpm__={"pnpm add @tiptap/extension-underline"}
  __bun__={"bun add @tiptap/extension-underline"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-text-align"}
  __yarn__={"yarn add @tiptap/extension-text-align"}
  __pnpm__={"pnpm add @tiptap/extension-text-align"}
  __bun__={"bun add @tiptap/extension-text-align"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-highlight"}
  __yarn__={"yarn add @tiptap/extension-highlight"}
  __pnpm__={"pnpm add @tiptap/extension-highlight"}
  __bun__={"bun add @tiptap/extension-highlight"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-subscript"}
  __yarn__={"yarn add @tiptap/extension-subscript"}
  __pnpm__={"pnpm add @tiptap/extension-subscript"}
  __bun__={"bun add @tiptap/extension-subscript"}
/>
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-superscript"}
  __yarn__={"yarn add @tiptap/extension-superscript"}
  __pnpm__={"pnpm add @tiptap/extension-superscript"}
  __bun__={"bun add @tiptap/extension-superscript"}
/>
...
```tsx
import { YouTubeEmbed, RichTextEditor } from "@editorcn/editor";
...
```tsx
import { TwitterEmbed, RichTextEditor } from "@editorcn/editor";
...
```tsx
import { YouTubeEmbed, TwitterEmbed, RichTextEditor } from "@editorcn/editor";
...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-placeholder"}
  __yarn__={"yarn add @tiptap/extension-placeholder"}
  __pnpm__={"pnpm add @tiptap/extension-placeholder"}
  __bun__={"bun add @tiptap/extension-placeholder"}
/>
...
```tsx
import { RichTextEditor, DEFAULT_LABELS } from "@editorcn/editor";
...
```tsx
import { DEFAULT_LABELS } from "@editorcn/editor";
...
```tsx
import { RichTextEditor, DEFAULT_ICONS } from "@editorcn/editor";
...
<CodeBlockCommand
  __npm__={"npm install lowlight @tiptap/extension-code-block-lowlight"}
  __yarn__={"yarn add lowlight @tiptap/extension-code-block-lowlight"}
  __pnpm__={"pnpm add lowlight @tiptap/extension-code-block-lowlight"}
  __bun__={"bun add lowlight @tiptap/extension-code-block-lowlight"}
/>
