...
```shell frame="none"
yarn add @rtecn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder
```
...
```shell frame="none"
bun add @rtecn/editor @tiptap/react @tiptap/pm @tiptap/starter-kit @tiptap/extension-link @tiptap/extension-placeholder
```
...
```shell frame="none"
bun add @tiptap/extension-subscript
```
...
```shell frame="none"
bun add @tiptap/extension-superscript
```
