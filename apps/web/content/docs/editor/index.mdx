...
<CodeBlockCommand
  __npm__={"npm install @tiptap/extension-character-count"}
  __yarn__={"yarn add @tiptap/extension-character-count"}
  __pnpm__={"pnpm add @tiptap/extension-character-count"}
  __bun__={"bun add @tiptap/extension-character-count"}
/>
...
```tsx
import { YouTubeEmbed, TwitterEmbed, RichTextEditor } from "@/components/editor";
